    ...
    constructor(camera: Camera, target: HTMLElement) {
        ...
        const releasePointer = (pointerId: number) => {
            try {
                ...
                // Ignore stale pointer captures. The controller state below is still reset.
            }
        ...
        wrap(target, 'pointercancel', resetPointerState);
        wrap(target, 'lostpointercapture', resetPointerState);
