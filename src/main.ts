...
import { CloneSelection } from './tools/clone-selection';
import { EndRefinement } from './tools/end-refinement';
...
const main = async () => {
    ...
    toolManager.register('cloneSelection', new CloneSelection(events, scene, editorUI.toolsContainer.dom, editorUI.canvasContainer));
    toolManager.register('endRefinement', new EndRefinement(events, scene, editorUI.canvasContainer));
